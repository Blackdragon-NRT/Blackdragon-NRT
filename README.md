...
# 🕸️ Blackdragon-NRT
### *Breaking systems by understanding how they breathe.*

![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=00FF00&center=true&vCenter=true&width=435&lines=Currently+studying+Web+Security;Diving+into+Linux+Internals;Mastering+JS+%26+Node.js+Architecture;Future+Red+Teamer)
...
- **V8 Engine Internals:** Call stack, heap memory, garbage collection, JIT compilation.
- **Async Programming:** Event Loop phases, microtask/macrotask queues, non-blocking I/O patterns.
- **Core Modules:** `http`, `fs`, `stream`, `eventEmitter`, `crypto` — building servers from scratch.
- **Security Implications:** Prototype pollution, insecure deserialization, ReDoS, dependency risks.
- **Tooling:** Writing custom scanners and PoCs in Node.js for web testing automation.

### 🐧 Linux System Internals
*Mastering the OS that powers the security world.*
- **Filesystem Mastery:** FHS, permissions, links (hard/soft), virtual filesystem (`/proc`, `/sys`).
...
I sharpen my algorithmic thinking and scripting logic on **Codewars**:

[![Codewars](https://www.codewars.com/users/Blackdragon-NRT/badges/large)](https://www.codewars.com/users/Blackdragon-NRT)
...
<p align="center">
  <img src="https://img.shields.io/badge/OS-Ubuntu%20%26%20WSL-blue?style=for-the-badge&logo=ubuntu&logoColor=white" />
...
![Footer Wave](https://capsule-render.vercel.app/api?type=wave&color=auto&height=200&section=footer)
